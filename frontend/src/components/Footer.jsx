...
export default function Footer({ onOpenInquiry }) {
  ...
  return (
    <footer className="bg-[#171717] text-[#C7C7C7] border-t border-neutral-800 select-none transition-colors duration-300">
      <div className="max-w-container-max mx-auto px-4 md:px-margin-desktop py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-12 text-left">
        ...
        <div className="lg:col-span-2">
          <h5 className="font-bold text-xs uppercase tracking-widest text-white mb-6">
            Quick Links
          </h5>
        ...
        <div className="lg:col-span-3">
          ...
          <div className="bg-[#222225] border border-neutral-800 p-6 rounded-2xl space-y-4 shadow-md">
